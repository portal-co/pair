...
pub trait CallIndirect<M: ModLike<Fun = F>,F: FunLike<Value = Self>,X,Err>: Call<M,F,X,Err>{
...
pub trait BindFun<M: ModLike<Fun = F>,F: FunLike<Value = Self>,X,E>: CallIndirect<M,F,X,E>{
